...
--
-- Estructura de tabla para la tabla `fotos_inmueble`
--
...
--
-- Volcado de datos para la tabla `fotos_inmueble`
--
...
--
-- Indices de la tabla `fotos_inmueble`
--
ALTER TABLE `fotos_inmueble`
  ADD PRIMARY KEY (`id_foto`),
  ADD KEY `fk_foto_inmueble` (`id_inmueble`);
...
--
-- Filtros para la tabla `fotos_inmueble`
--
ALTER TABLE `fotos_inmueble`
  ADD CONSTRAINT `fk_foto_inmueble` FOREIGN KEY (`id_inmueble`) REFERENCES `inmueble` (`id_inmueble`) ON DELETE CASCADE;
